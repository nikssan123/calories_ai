...
export const en = {
  ...
  'today.stepsNoSourceHint':
    'Health Connect still has nothing. Some phones need another app to do the counting — tap to open its app list and allow Samsung Health or Fitbit.',
  ...
  // ---- Coach ----------------------------------------------------------------
  'coach.title': 'Coach',
  'coach.footerNone': 'A coach sees what you switch on and can write into your journal. Nothing is shared until you accept a code.',
  'coach.enterCode': 'Enter a coach’s code',
  'coach.codePlaceholder': 'XXXX-XXXX',
  'coach.continue': 'Continue',
  'coach.sharedWith': (name: string) => `Shared with ${name}`,
  'coach.since': (date: string) => `since ${date}`,
  'coach.scopeMeals': 'Meals and photos',
  'coach.scopeMealsHint': 'What you ate and when',
  'coach.scopeWeight': 'Weight',
  'coach.scopeWeightHint': 'Your weigh-ins and the trend',
  'coach.scopeMetrics': 'Steps, sleep, heart',
  'coach.scopeMetricsHint': 'From your phone or watch',
  'coach.footerLinked': (name: string) => `${name} can set your calorie and macro targets. You can always change them back, and you can stop sharing any time.`,
  'coach.stopSharing': 'Stop sharing',
  'coach.stopConfirm': (name: string) => `Stop sharing with ${name}? They see nothing new from now on. Comments already in your journal stay.`,
  'coach.stop': 'Stop',
  'coach.keep': 'Keep sharing',
  'coach.stopped': 'You stopped sharing.',
  'coach.inviteTitle': (name: string) => `${name} wants to coach you`,
  'coach.willSee': 'They will see',
  'coach.wontSee': 'They will not see',
  'coach.seeMeals': 'Your meals and their photos',
  'coach.seeTotals': 'Daily calories and macros',
  'coach.seeWeight': 'Your weight and targets',
  'coach.seeDays': 'Which days you logged',
  'coach.notChat': 'Your chat with the journal',
  'coach.notMetrics': 'Steps, sleep or heart data, unless you turn it on',
  'coach.notEmail': 'Your email or billing',
  'coach.accept': 'Accept',
  'coach.notNow': 'Not now',
  'coach.close': 'Close',
  'coach.canStop': 'You can stop sharing any time from Settings.',
  'coach.accepted': (name: string) => `Sharing with ${name}.`,
  'coach.alreadyLinked': (name: string) => `You already share your log with ${name}. Stop sharing first.`,
  'coach.invalid': 'That code is not one we recognise.',
  'coach.expired': 'That code has expired. Ask your coach for a new one.',
  'coach.used': 'That code has already been used.',
  'coach.bannerManage': 'Manage',
  'coach.yourCoach': 'your coach',
  'coach.yourCoachCapital': 'Your coach',
  'coach.setByCoach': 'Set by your coach',
  'coach.seatPlus': 'their seat puts you on Plus',
  ...
  'auth.emailTaken': 'That email already has an account. Sign in instead.',
  ...
  'save.signInWarning': 'Signing in to it brings the meals from this phone with you.',
  ...
  'save.switchedBody': 'That Google account already had an account here, so you’re signed in to it — and the meals from this phone are in it now.',
