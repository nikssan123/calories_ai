...
export const hr: Messages = {
  ...
  'auth.invalidEmail': 'To ne izgleda kao adresa e-pošte.',
  'auth.emailTaken': 'Za ovu e-poštu već postoji račun. Prijavi se u njega.',
  'auth.wrongPassword': 'Pogrešna e-pošta ili lozinka.',
  ...
  'plans.trialOverTitle': 'Tvoja besplatna proba je završila.',
