...
export const sk: Messages = {
  ...
  'save.trialBody': (days: number, perDay: number) =>
    `Ulož si ho — je to zadarmo — a získaš ${days}-dňové skúšobné obdobie: ${perDay} ${w(perDay, { one: 'správa', few: 'správy', many: 'správy', other: 'správ' })} denne a jedno skenovanie fotky. Všetko, čo si zapísal, zostane.`,
  ...
  'save.signInWarning': 'Keď sa doň prihlásiš, jedlá z tohto telefónu sa nepresunú.',
  ...
  'save.switchedBody': 'K tomu účtu Google tu už účet bol, takže si prihlásený doň. Jedlá z tohto telefónu sa nepresunuli.',
