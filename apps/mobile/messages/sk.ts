...
export const sk: Messages = {
  ...
  'auth.invalidEmail': 'Toto nevyzerá ako e-mailová adresa.',
  'auth.emailTaken': 'S týmto e-mailom už účet existuje. Prihlás sa doň.',
  'auth.wrongPassword': 'Nesprávny e-mail alebo heslo.',
  ...
  'save.signInWarning': 'Keď sa doň prihlásiš, jedlá z tohto telefónu prejdú s tebou.',
  'save.signInInstead': 'Prihlásiť sa do toho účtu',
  'save.changeEmail': 'Použiť iný e-mail',
  'save.codeStale': 'Ten kód bol pre inú adresu. Pošli nový.',
  'save.doneTitle': 'Účet *uložený*',
  'save.doneBody': (days: number) => `Tvoje ${days}-dňové skúšobné obdobie sa začalo. Všetko zapísané je tu.`,
  'save.switchedTitle': 'Si *prihlásený*',
  'save.switchedBody': 'K tomu účtu Google tu už účet bol, takže si prihlásený doň — a jedlá z tohto telefónu sú teraz v ňom.',
  'save.continue': 'Pokračovať',
  ...
  'guest.eraseConfirm': 'Vymazať všetko',
  'guest.startRefused': 'Z tohto pripojenia teraz vzniklo príliš veľa nových účtov. Prihlás sa alebo to skús neskôr.',
  ...
  'plans.leftInTrial': (left: string, when: string) => `ešte ${left} · skúšobné obdobie sa skončí ${when}`,
  ...
  'cast.showedUp': 'Ani jeden vynechaný deň.',
  'cast.keepGoing': 'Len tak ďalej',
