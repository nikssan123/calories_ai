...
export const sr: Messages = {
  ...
  'auth.invalidEmail': 'Ово не личи на имејл адресу.',
  'auth.emailTaken': 'За овај имејл већ постоји налог. Пријави се на њега.',
  'auth.wrongPassword': 'Погрешан имејл или лозинка.',
  ...
  'save.signInWarning': 'Ако се пријавиш на њега, оброци са овог телефона иду са тобом.',
  ...
  'save.switchedTitle': 'Пријављен *си*',
  'save.switchedBody': 'Тај Google налог је овде већ имао налог, па си пријављен на њега — а оброци са овог телефона су сада у њему.',
  'save.continue': 'Настави',
  'save.later': 'Не сада',
  ...
  'plans.billedWeekly': 'Наплаћује се недељно',
  ...
  'invite.fromThisPhone':
    'Подсетник иде са овог телефона и можеш да га промениш или искључиш у „Профилу“. Ако ти дневник утихне првих дана, јавићемо се једном.',
